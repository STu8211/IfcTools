...
from AttrFiltered import delete_ifc_attributes
...
class IfcCleanerApp(QMainWindow):
    ...
    def clean_ifc_file(self):
        ...
        delete_ifc_attributes(self.ifc_file_path, output_file_path, attributes, entity_name, predefined_type, object_type)
